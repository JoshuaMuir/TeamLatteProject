   ...
   private BufferedImage image;
    ...
    protected void paintComponent(Graphics g) {
     ...
     if(whey==0) create();
        ...
        g2.setBackground(Color.black);Font myFont=new Font("Serif",Font.BOLD,48);
        g2.setFont(myFont);
        Rectangle rect1 = new Rectangle(0, 0, 1000, 900);
        Rectangle rect2 = new Rectangle(0, 0, 1000, 900);
...
//g2.fill(circle);
        g2.setColor(Color.black);
//        NotGraphics bye=new NotGraphics();
        g2.drawImage(image, 0, 0, this);
        //g.drawImage(image,0.0)
        
         if(NotGraphics.GameOver>=1){
            // g2.fill(rect2);
             g2.setColor(Color.white);
             NotGraphics.bottomLabel.setText("Click reset to play again!");
         if(Referee1.whoWon==1){
         g2.drawString("damn son you didnt won", 200, 200);
         
         }else g2.drawString("damn son you did won", 200, 200);
